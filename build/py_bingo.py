...
class Assets:
    ...
    def __init__(self):
        self.img_balls = [pg.image.load(os.path.join(DIR_PATH,"imgs","ball_{:>02}.{}".format(x,self.default_img_format))) for x in range(5)]
...
class Fonts:    
    ...
    def use_font(self,name,size):
        try:
            ...
            tools.debug_msg("Font Error!",1,DEBUG_LEVEL)
...
class Game:
    ...
    def __init__(self):
        ...
        self.system_colors = Assets.theme_tropical
    ...
    def add_player(self,player):
        ...
        tools.debug_msg("{} joined the game".format(player.name),1,DEBUG_LEVEL)
    def remove_player(self,player):
        self.players.remove(player)
        tools.debug_msg("{} left the game".format(player.name),1,DEBUG_LEVEL)
...
class Player:
    ...
    def give_cards(self,count):
        tools.debug_msg("Giving card to {}".format(self.name),1,DEBUG_LEVEL)
...
class Ball:
    ...
    def __init__(self,num):
        ...
        Ball.ball_count+=1
        tools.debug_msg("Ball Picked: {}".format(self.num),1,DEBUG_LEVEL)
...
class Card_Cell:
    ...
    def draw(self):
        if tools.check_mouseover(self.rect):   
            tools.debug_msg("Mouseover {}".format(self.unit_pos),2,DEBUG_LEVEL)
        ...
        SCREEN.win.blit(text_label,text_num_pos)
